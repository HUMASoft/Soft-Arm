...
//        m3.SetPosition(posan3);
        cout << 10*v_lengths[0] << endl;
        cout << 10*v_lengths[1] << endl;
        cout << 10*v_lengths[2] << endl;

        m1.SetVelocity(10*v_lengths[0]);
        m2.SetVelocity(10*v_lengths[1]);
        m3.SetVelocity(10*v_lengths[2]);
